...
public class ProductServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.ProductService {
    ...
    private java.lang.String Product_address = "http://localhost:8080/WebServiceTwo/services/Product";
    ...
    public DefaultNamespace.Product getProduct(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.ProductSoapBindingStub _stub = new DefaultNamespace.ProductSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.Product.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.ProductSoapBindingStub _stub = new DefaultNamespace.ProductSoapBindingStub(new java.net.URL(Product_address), this);
                _stub.setPortName(getProductWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "ProductService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "Product"));
        }
